...
export default async function NuevaGeneracionPage({
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/dashboard/codigos-barra/nueva" className="text-brand-600 text-sm underline">
          ← Elegir varios productos a la vez
        </Link>
        <p className="eyebrow mb-1 mt-2">Catálogo · 04</p>
        <h1 className="page-title">Generar códigos ligados a un lote</h1>
