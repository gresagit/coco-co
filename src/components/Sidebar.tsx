      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { href: "/dashboard/insumos/codigos-barra", label: "Generar códigos de barras" },
            { href: "/dashboard/insumos/codigos-barra/historial", label: "Historial de códigos de barras" },
          ],
        },
